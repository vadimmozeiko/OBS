    ...
    <div class="pl-md-5 pr-md-5 mb-5">
        ...
        <form action="{{route('message.sendReply', $message)}}" method="POST">
            <div class="form-group row">
                <label for="category" class="col-md-10 col-form-label text-md-left">To</label>
                <div class="col-md-10">
                    <input id="category" type="text" class="form-control" name="email" value="{{$message->email}}"
                           disabled>
                </div>
            </div>

            <div class="form-group row">
                <label for="category" class="col-md-10 col-form-label text-md-left">Subject</label>
                <div class="col-md-10">
                    <input id="category" type="text" class="form-control" name="subject"
