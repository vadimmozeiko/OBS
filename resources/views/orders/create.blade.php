                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group">
                            <form style="width: 100%;" method="POST" action="{{route('order.store')}}" enctype="multipart/form-data">
                                ...
                                <input class="form-control @error('user_name') is-invalid @enderror" type="text" name="user_name" value="{{old('user_name', $user->name)}}">
                                @error('user_name')
                                ...
                                <input class="form-control @error('user_email') is-invalid @enderror" type="email" name="user_email" value="{{old('user_email', $user->email)}}">
                                @error('user_email')
                                <small class="invalid-feedback mb-3" role="alert">
                                    <strong>{{ $message }}</strong>
                                </small>
                                ...
                                <input class="form-control @error('user_address') is-invalid @enderror" type="text" name="user_address" value="{{old('user_address' ,$user->address)}}">
                                @error('user_address')
                                <small class="invalid-feedback mb-3" role="alert">
                                    <strong>{{ $message }}</strong>
                                </small>
                                ...
                                <input class="form-control @error('user_phone') is-invalid @enderror" type="number" name="user_phone" value="{{old('user_phone', $user->phone)}}">
                                @error('user_phone')
                                <small class="invalid-feedback mb-3" role="alert">
                                    <strong>{{ $message }}</strong>
                                </small>
                                ...
                                <input id="datepicker"  class="form-control mb-3" type="text" name="date" value="{{old('date', $request->order_date)}}">
