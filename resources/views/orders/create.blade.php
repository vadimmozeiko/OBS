                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group ">
                            <form style="width: 100%;" method="POST" action="{{route('order.store')}}" enctype="multipart/form-data">
                                ...
                                <input class="form-control mb-3" type="text" name="user_name" value="{{$user[0]->name}}" required>
                                <span class="input-group-addon" id="basic-addon1">Email *</span>
                                <input class="form-control mb-3" type="email" name="user_email" value="{{$user[0]->email}}" required>
                                ...
                                <input id="datepicker"  class="form-control mb-3" type="text" name="order_date" value="{{$request->order_date}}">
